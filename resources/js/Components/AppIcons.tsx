...
export function IconGithub({ className }: IconProps) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className={cn("fill-current size-6", className)}>
...
export function IconMoon({ className }: IconProps) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className={cn("fill-current size-6", className)}>
...
export function IconSun({ className }: IconProps) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className={cn("fill-current size-6", className)}>
